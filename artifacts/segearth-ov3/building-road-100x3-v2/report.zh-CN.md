...
|---|---:|---:|---:|---:|---:|
| Change-Agent | 0.606 | 0.805 | 0.878 | 0.655 | 0.475 |
| Draft | 0.555 | 0.849 | 0.815 | 0.654 | 0.427 |
| Guided | 0.552 | 0.830 | 0.815 | 0.640 | 0.443 |

## 分实体诊断

| 实体 | Claims | Faithfulness | Spatial | Temporal | Confidence | 状态 |
|---|---:|---:|---:|---:|---:|---|
| building | 250 | 0.638 | 0.473 | 0.943 | 0.889 | contradicted=35, supported=71, unverifiable=144 |
| road | 185 | 0.666 | 0.415 | 0.480 | 0.957 | contradicted=57, supported=106, unverifiable=22 |
| scene | 6 | 0.000 | 0.000 | - | 1.000 | contradicted=6 |
...
| levir-cc_test_000064 | 0.531 | 0.531 | 0.531 |
...
| levir-cc_test_000200 | 0.532 | 0.532 | 0.829 |
| levir-cc_test_000205 | 0.760 | 0.000 | 0.760 |
...
| levir-cc_test_000314 | 0.848 | 0.848 | 0.848 |
...
| levir-cc_test_000623 | 0.000 | 0.000 | 0.810 |
...
| levir-cc_test_000673 | 0.461 | 0.000 | 0.671 |
| levir-cc_test_000706 | 0.516 | 0.516 | 0.783 |
| levir-cc_test_000721 | 0.871 | 0.871 | 0.871 |
| levir-cc_test_000727 | 0.528 | 0.528 | 0.822 |
| levir-cc_test_000730 | 0.394 | 0.394 | 0.537 |
| levir-cc_test_000748 | 0.721 | 0.721 | 0.746 |
...
| levir-cc_test_000825 | 0.539 | 0.539 | 0.828 |
| levir-cc_test_000851 | 0.692 | 0.692 | 0.692 |
| levir-cc_test_000861 | 0.570 | 0.570 | 0.795 |
| levir-cc_test_000879 | 0.641 | 0.641 | 0.641 |
...
- Change type 分布：{'add': 345, 'none': 85, 'modify': 10, 'remove': 1}
...
| levir-cc_test_000064 | Draft | road | contradicted | 0.000 | 0.000 | 0.000 | 0.977 |
| levir-cc_test_000064 | Guided | road | contradicted | 0.000 | 0.000 | 0.000 | 0.977 |
| levir-cc_test_000064 | Change-Agent | road | contradicted | 0.000 | 0.000 | 0.000 | 0.977 |
...
| levir-cc_test_000200 | Draft | road | contradicted | 0.000 | 0.000 | 0.000 | 0.992 |
| levir-cc_test_000200 | Guided | road | contradicted | 0.000 | 0.000 | 0.000 | 0.992 |
